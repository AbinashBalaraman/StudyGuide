...
def generate_study_questions(input_text, num_questions, question_type):
    ...
    prompt = f"""Generate {num_questions} focusing on {question_type} questions based on the following text:\n\n{input_text}\n\n The questions should be designed to test understanding of the key concepts and encourage critical thinking. Format each question as a separate numbered item"""
    try:
